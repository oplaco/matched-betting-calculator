...
from matched_betting_calculator.back_lay_strategy.back_lay_accumulated_calculator import BackLayAccumulatedNormalCalculator, BackLayAccumulatedFreebetCalculator, BackLayAccumulatedReimbursementCalculator
...
class TestBackLayAccumulatedCalculator(unittest.TestCase):
    ...
    def test_calculate_two_picks_accumulated_normal(self):
        calc = BackLayAccumulatedNormalCalculator(self.acc1_combo_stake, self.acc1_back_bet_fee,self.acc1_bl_group)
    ...
    def test_calculate_four_picks_accumulated_normal(self):
        calc = BackLayAccumulatedNormalCalculator(self.acc2_combo_stake, self.acc2_back_bet_fee,self.acc2_bl_group)
        result = calc.calculate_stake()
    ...
    def test_calculate_two_picks_accumulated_freebet(self):
        calc = BackLayAccumulatedFreebetCalculator(self.acc1_combo_stake, self.acc1_back_bet_fee,self.acc1_bl_group)
        result = calc.calculate_stake()
    ...
    def test_calculate_four_picks_accumulated_freebet(self):
        calc = BackLayAccumulatedFreebetCalculator(self.acc2_combo_stake, self.acc2_back_bet_fee,self.acc2_bl_group)
        result = calc.calculate_stake()
    ...
    def test_calculate_two_picks_accumulated_reimbursement(self):
        reimbursement = 50
        calc = BackLayAccumulatedReimbursementCalculator(self.acc1_combo_stake, self.acc1_back_bet_fee,self.acc1_bl_group,reimbursement)
        result = calc.calculate_stake()
    ...
    def test_calculate_four_picks_accumulated_reimbursement(self):
        combo_stake = 50
        reimbursement = 25
        calc = BackLayAccumulatedReimbursementCalculator(combo_stake, self.acc2_back_bet_fee,self.acc2_bl_group,reimbursement)
        result = calc.calculate_stake()
